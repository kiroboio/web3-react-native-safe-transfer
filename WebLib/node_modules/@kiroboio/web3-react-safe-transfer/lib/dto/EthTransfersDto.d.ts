declare type EthTransferState = 'waiting-for-deposit' | 'retrieving' | 'retrieved' | 'ready' | 'collecting' | 'collected' | 'swapping' | 'swapped' | 'rejected' | 'invalid' | 'new' | 'creating' | 'unknown';

...
exports.useWeb3 = exports.Connectors = void 0;
...
var mewconnect_connector_1 = require("@myetherwallet/mewconnect-connector");
...
var useWeb3 = function () {
    var _a;
    var _b = core_1.useWeb3React(), connector = _b.connector, library = _b.library, chainId = _b.chainId, account = _b.account, activate = _b.activate, deactivate = _b.deactivate, active = _b.active, error = _b.error;
    var RPC_URLS = {
    ...
    var inAppWalletConnect = function () {
        return new InAppWalletConnector_1.default({ urls: { 4: RPC_URLS[4] }, defaultChainId: 4 });
    };
    var injected = function (params) {
        return new injected_connector_1.InjectedConnector(__assign({}, params));
    }; // supportedChainIds: [1, 4] })
    var walletConnect = function (params) {
        return new walletconnect_connector_1.WalletConnectConnector(__assign({ rpc: { 4: RPC_URLS[4], 1: RPC_URLS[1] }, bridge: 'https://bridge.walletconnect.org', qrcode: true, pollingInterval: POLLING_INTERVAL }, params));
    };
    var walletLink = function (params) {
        return new walletlink_connector_1.WalletLinkConnector(__assign({ url: RPC_URLS[1], appName: 'dapp.kirobo.me' }, params));
    };
    var myEtherWallet = function (params) {
        return new mewconnect_connector_1.MewConnectConnector(__assign({ url: RPC_URLS[1] }, params));
    };
    var frame = function (params) {
        return new frame_connector_1.FrameConnector(__assign({ supportedChainIds: [4] }, params));
    };

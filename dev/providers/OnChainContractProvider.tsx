...
const DispatchContext =
  React.createContext<((a: OnChainContractAction) => void) | undefined>(
    undefined
  );
...
export const ContractProvider = ({
  ...
  const [onChain, dispatchOnChainContact] = useReducer(
    contractReducer,
    initContract
  );
  ...
  return (
    <ContractContext.Provider value={onChain}>
      <DispatchContext.Provider value={dispatchOnChainContact}>
        {children}

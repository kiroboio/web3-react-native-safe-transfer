...
import { useLocalStorage } from './hooks/useLocaleStroage';
...
import InAppWalletConnector from 'src/kirobo/customConnectors/InAppWalletConnector';
import useWallet from 'src/kirobo/hooks/useWallet';

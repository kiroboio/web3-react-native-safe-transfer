      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return new Promise(function (resolve) { resolve(_interopNamespace(require('@myetherwallet/mewconnect-web-client'))); });
...
exports.MewConnectConnector = MewConnectConnector;
//# sourceMappingURL=mewconnect-connector.cjs.development.js.map

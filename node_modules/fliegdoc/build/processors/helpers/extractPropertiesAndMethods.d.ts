 ...
 * ```
 */
export declare function extractPropertiesAndMethods(structure: ClassDeclarationStructure | InterfaceDeclarationStructure, node: ClassDeclaration | InterfaceDeclaration): void;
//# sourceMappingURL=extractPropertiesAndMethods.d.ts.map
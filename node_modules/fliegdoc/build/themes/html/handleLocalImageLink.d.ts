 ...
 * ```
 */
export declare function handleLocalImageLink(altText: string, link: string, staticFiles: Record<string, string>, config: FliegdocConfig): string;
//# sourceMappingURL=handleLocalImageLink.d.ts.map
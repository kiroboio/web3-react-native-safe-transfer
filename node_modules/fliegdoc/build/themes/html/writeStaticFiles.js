...
exports.writeStaticFiles = void 0;
 ...
 * ```
 */
function writeStaticFiles(staticFiles, createFile, config) {
    return __awaiter(this, void 0, void 0, function* () {
        for (const origPath in staticFiles) {
            if (Object.prototype.hasOwnProperty.call(staticFiles, origPath)) {
                yield createFile(path_1.default.join(config.outDir, staticFiles[origPath]), yield fsp.readFile(origPath), path_1.default.extname(origPath));
            }
        }
    });
}
exports.writeStaticFiles = writeStaticFiles;
//# sourceMappingURL=writeStaticFiles.js.map
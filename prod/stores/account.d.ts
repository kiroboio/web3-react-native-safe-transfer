...
import { IAnyType, SnapshotIn, SnapshotOut, TypeOfValue } from "mobx-state-tree";
import { Instance } from "mobx-state-tree";
import { Connectors } from "../hooks/useWeb3";
import { Chainlink, Kirobo } from "../icons";
...
export declare const Transfer: import("mobx-state-tree").IModelType<{
    ...
    state: import("mobx-state-tree").IType<"waiting-for-deposit" | "retrieving" | "retrieved" | "ready" | "collecting" | "collected" | "rejected" | "invalid" | "new" | "creating" | "unknown", "waiting-for-deposit" | "retrieving" | "retrieved" | "ready" | "collecting" | "collected" | "rejected" | "invalid" | "new" | "creating" | "unknown", "waiting-for-deposit" | "retrieving" | "retrieved" | "ready" | "collecting" | "collected" | "rejected" | "invalid" | "new" | "creating" | "unknown">;
...
export declare const Transfers: import("mobx-state-tree").IModelType<{
    ...
    readonly list: ({
        ...
        salt: string;
        secretHash: string;
        state: "waiting-for-deposit" | "retrieving" | "retrieved" | "ready" | "collecting" | "collected" | "rejected" | "invalid" | "new" | "creating" | "unknown";
    ...
    readonly list: (number | [any] | ((() => string) & (() => string)) | (() => void) | ((key: string) => boolean) | ((key: string) => boolean) | (() => IterableIterator<string>) | "Map" | (() => IterableIterator<{
        id: string;
        txid: string;
        from: string;
        to: string;
...
declare const OnChainTransaction: import("mobx-state-tree").IModelType<{
    ...
    state: import("mobx-state-tree").IOptionalIType<import("mobx-state-tree").ISimpleType<"rejected" | "failed" | "pending" | "success" | "idle" | "queue" | "init">, [undefined]>;
    ...
    update: (trx: {
        ...
        state: "rejected" | "failed" | "pending" | "success" | "idle" | "queue" | "init";
...
export declare const tokens: {
    ...
    readonly LINK: {
        readonly icon: typeof Chainlink;
        readonly label: "LINK";
        readonly address: {
...
export declare const OnChainToken: import("mobx-state-tree").ISimpleType<"KIRO" | "LINK" | "none" | "USDT" | "BNB" | "UNI" | "SUSHI">;
declare const OnChainTokens: import("mobx-state-tree").IModelType<{
    token: import("mobx-state-tree").IOptionalIType<import("mobx-state-tree").ISimpleType<"KIRO" | "LINK" | "none" | "USDT" | "BNB" | "UNI" | "SUSHI">, [undefined]>;
    ...
    setToken: (token: "KIRO" | "LINK" | "none" | "USDT" | "BNB" | "UNI" | "SUSHI") => void;
    getToken: () => "KIRO" | "LINK" | "none" | "USDT" | "BNB" | "UNI" | "SUSHI";
}, import("mobx-state-tree")._NotCustomized, import("mobx-state-tree")._NotCustomized>;
...
export declare const Account: import("mobx-state-tree").IModelType<{
    ...
    chainId: import("mobx-state-tree").IOptionalIType<import("mobx-state-tree").ISimpleType<"notSupportedChainId" | "1" | "4">, [undefined]>;
...
export declare type AccountStoreType = Instance<ReturnType<typeof Account.create>>;
interface CMD {
    is: {
        ready: boolean;
        running: boolean;
...
export interface IAccountStoreNice {
    wallet: {
        data: string;
        clearCmd: CMD;
        removeCmd: CMD;
...
export declare type ITransfers = TypeOfValue<Instance<typeof Transfers>>;
export {};
